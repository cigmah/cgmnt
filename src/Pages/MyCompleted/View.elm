module View.CompletedAuth exposing (view)
    ...
    let
        ...
        puzzleModal =
            case data of
                ...
                Success (ArchiveDetail puzzles selectedPuzzle) ->
                    detailPuzzle selectedPuzzle "" Nothing <| CompletedMsg OnDeselectCompletedPuzzle
    ...
    section [ class "hero is-dark" ]
        [ div [ class "hero-body" ]
            [ div [ class "container" ]
                ...
                , h2 [ class "subtitle" ]
                    [ text "Puzzles you've completed this year." ]
                ]
            ]
        ]
...
mainContainer puzzles =
    div [] [ lazy (\_ -> banner) Nothing, section [ class "hero-body" ] [ div [ class "container" ] [ puzzleContainer puzzles <| CompletedMsg << OnSelectCompletedPuzzle ] ] ]
