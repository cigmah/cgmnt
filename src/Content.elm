...
There is a lot of content in medical school, but we believe medical students
will find coding a breath of fresh air. Instead of memory-intensive learning,
coding is often an exercise in logical thinking. Checking documentation is easy
and encouraged. Programs are (mostly) verifiable constructs. There's no more
putting your faith in information simply because someone higher-ranked told you
so - information is free, open and often much closer to theory than the
empiricisms of evidence-based medicine.
